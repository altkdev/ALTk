...
function skipnav() {
    if(secrets)
        document.getElementById("main-text").innerHTML = "<a href=''>PRESS ALT K !!"
    else
        document.getElementById("main-text").innerHTML = "<a href=''>PRESS ALT K !! There are also hiden ester eggs"
    secrets = !secrets;
}
