...
define( 'YOURLS_COOKIEKEY', 'a}0QBfEczV5IrRZWfNd#Wpt%_P4s1am]v[X4aO)#' );
...
*/
$yourls_reserved_URL = [
	'porn', 'faggot', 'sex', 'nigger', 'fuck', 'cunt', 'dick', 'pages', 'videos', 'javascript', 'css', 'background', 'license', 'cname',
];
